...
func TestLog(t *testing.T) {
	...
	log.Info("this will be printing2")
	log.Infof("this will be printing2:%s", "yeah")
	log.Warn("this will be printing2")
	log.Warnf("this will be printing2:%s", "yeah")
	log.Error("this will be printing2")
	log.Errorf("this will be printing2:%s", "yeah")
